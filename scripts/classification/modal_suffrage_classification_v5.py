...
# V5: Uses context actively for argument extraction
...
def main(
    ...
    if pilot:
        ...
        local_input = "outputs/llm_classification/full_input_context_3.parquet"
        remote_input = "full_input_context_3.parquet"
        output_file = "full_results_v5_context_3.parquet"
        print("="*60)
        print("FULL DATASET MODE (v5 with context=3)")
        print("="*60)
