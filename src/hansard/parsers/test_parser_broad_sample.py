#!/usr/bin/env python3
"""
Test parser on a broad sample of files across different years and decades
"""
...
def sample_files_from_years(base_path, sample_years, files_per_year=5):
...
def main():
    # Sample from different decades to test parser robustness
    sample_years = [
    ...
    print(f"Sampling files from years: {sample_years}")
    print("=" * 60)
    ...
    for file_path in sampled_files:
        ...
        year = file_path.split('/')[-3]  # assuming path/to/hansard/YEAR/month/file.html.gz
